...
ActiveRecord::Schema[7.0].define(version: 2023_06_14_070006) do
  ...
  create_table "available_slots", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["property_id"], name: "index_available_slots_on_property_id"
  end
  ...
  create_table "seats", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["property_id"], name: "index_seats_on_property_id"
  end

  add_foreign_key "addresses", "properties"
  add_foreign_key "available_slots", "properties"
  add_foreign_key "properties", "companies"
  add_foreign_key "rooms", "properties"
  add_foreign_key "seats", "properties"
end
